      ...
      <Row id="about" style={{ height: '100vh' , flexDirection:"column"}}>
        <Col style={{ backgroundColor: '#323239', flex:1 , paddingTop:50 }}>
          <Container style={{ height: '100%' }}>
            <Row className="justify-content-md-center" style={{ height: '100%', alignItems: 'center', gap: '25px', flexWrap: 'nowrap' }}>
              <Col xs={12} md={6} style={{ display: 'flex', justifyContent: 'flex-end', flexDirection: 'column', alignItems: 'flex-end', borderRight: 'solid' }}>
                <h2>
